...
*/ 
extern uint32_t s_encode_image(uint8_t * input_ptr, uint8_t * output_ptr,
                        uint32_t quality_factor, int image_format,
                        uint32_t image_width, uint32_t image_height,
                        uint32_t output_buffer_size);
												
extern void RGB24_2_YCbCr444(uint8_t * input_ptr, uint8_t * output_ptr,
                      uint32_t image_width, uint32_t image_height);
											
extern void RGB24_2_YCbCr422(uint8_t * input_ptr, uint8_t * output_ptr,
                      uint32_t image_width, uint32_t image_height);
											
extern void RGB24_2_YCbCr420(uint8_t * input_ptr, uint8_t * output_ptr,
                      uint32_t image_width, uint32_t image_height);
											
extern void RGB24_2_YCbCr400(uint8_t * input_ptr, uint8_t * output_ptr,
                      uint32_t image_width, uint32_t image_height);
											
extern void RGB565_2_YCbCr420(uint8_t * input_ptr, uint8_t * output_ptr,
                         uint32_t image_width, uint32_t image_height);
												 
extern void RGB32_2_YCbCr420(uint8_t * input_ptr, uint8_t * output_ptr,
                        uint32_t image_width, uint32_t image_height);
